    ...
    <div :class="styles.information">
      <a-descriptions :column="1">
        <a-descriptions-item label="付款账户">
          {{ data.payAccount }}</a-descriptions-item
        >
        <a-descriptions-item label="收款账户">
          {{ data.receiverAccount }}</a-descriptions-item
        >
        <a-descriptions-item label="收款人姓名">
          {{ data.receiverName }}</a-descriptions-item
        >
        <a-descriptions-item label="转账金额">
          <a-statistic :value="data.amount" suffix="元" />
        </a-descriptions-item>
      </a-descriptions>
    </div>
  </a-result>
